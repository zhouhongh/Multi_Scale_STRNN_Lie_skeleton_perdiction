...
def train(config, checkpoint_dir):
    ...
    np.savez('./log/'+time_now+'.npz', trainloss_list=trainloss_list, validloss_list=validloss_list, Error_list=Error_list)
    ...
    for act in actions:
        if config.datatype == 'smpl':
            ...
            for i in range(y_predict[act].shape[0]):
                ...
                sio.savemat(output_dir + 'prediction_smpl_' + act + '_' + str(i) + '.mat', dict([('prediction', y_p)]))
                sio.savemat(output_dir + 'gt_smpl_' + act + '_' + str(i) + '.mat', dict([('gt', y_t)]))
...
## 训练指令
## python train.py --dataset Human
## python train.py --action walking --dataset Human
## python train.py --action sittingdown --dataset Human
## python train.py --action greeting --dataset Human
# python train.py --action dance_2_cha --dataset Human
# python train.py --action new_dance --dataset Human
# python train.py --action salsa_dance_2_ori --dataset Human
# python train.py --action walk_and_run --dataset Human
# python train.py --action jump --dataset Human
# python train.py --action kick --dataset Human
# python train.py --action run --dataset Human
# python train.py --action locomotion_orin --dataset Human
# python train.py --action walk_more --dataset Human
# python train.py --action walking_run_ori_filt2 --dataset Human
# python train.py --action walk_0901 --dataset Human
## 预测指令
## python train.py --dataset Human --training False --visualize False --action dance_2_cha
#训练中， screen name: CMU_10_50_walking  20

    parser = ArgumentParser()
    parser.add_argument("--changed", dest="changed", default=True, help="choose to use zhh's model")
    ...
    parser.add_argument("--visualize", type=bool, default=False, dest="visualize", help="visualize the prediction or not ")
